  ...
  return (
    <View style={styles.container}>
      <View style={styles.imageContainer}>
        <Image
          source={require('C:/Projects/ReactNative/vagary/src/utls/compare-prices.png')} // Update this with your actual image path
          style={styles.image}
          resizeMode="contain"
        />
      </View>
      ...
      <View style={styles.footerContainer}>
        ...
        >
          <LinearGradient
            ...
            <Image
              source={require('C:/Projects/ReactNative/vagary/src/utls/next-icon.png')} // Update with your actual icon path
...
const styles = StyleSheet.create({
  ...
  imageContainer: {
    ...
    alignItems: 'center',
    marginTop: 50, // Adjust to position the image properly
  },
  image: {
